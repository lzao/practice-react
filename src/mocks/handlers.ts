...
const taskHandler = rest.get(API_DOMAIN + '/region/province', (req, res, ctx) => {
  return res(
    ctx.status(200),
    ctx.delay(10),
    ctx.json([
...
export const taskErrorHandler = rest.get(API_DOMAIN + '/region/province', (req, res, ctx) => {
  return res(ctx.status(200), ctx.delay(10), ctx.json([]));
});

export const taskRealTimeConfirmedCase = rest.get(API_DOMAIN + '/region/real', (req, res, ctx) => {
  return res(
    ctx.status(200),
    ctx.json([
      {
...
export const taskRealTimeConfirmedCaseEmpty = rest.get(API_DOMAIN + '/region/real', (req, res, ctx) => {
  return res(ctx.status(200), ctx.json(null));
});

export const taskLive = rest.get(API_DOMAIN + '/region/live', (req, res, ctx) => {
  return res(
    ctx.status(200),
    ctx.json({
      today: 30260,
...
export const taskDailyConfirmedCase = rest.get(API_DOMAIN + '/region/daily', (req, res, ctx) => {
  return res(
    ctx.status(200),
    ctx.json([
      {
...
export const taskStat = rest.get(API_DOMAIN + '/region/stat', (req, res, ctx) => {
  return res(
    ctx.status(200),
    ctx.json({
